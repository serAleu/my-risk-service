...
CREATE TABLE IF NOT EXISTS credit_bureau_info (
  ...
  ccris_confirm_error_code varchar(50),
  ccris_confirm_response_dttm timestamp,
  ccris_confirm_response_json text,
  ccris_confirm_token1 varchar(50),
  ccris_confirm_token2 varchar(50),
...
CREATE TABLE IF NOT EXISTS credit_bureau_info_details (
  ...
  total_outstanding_balance_bnm numeric(19,2),
  balance_updated_date timestamp,
  installment_amount bigint,
  principle_repayment_term int,

...
public class SeonFraudChecksService implements BaseRiskChecksService {
  ...
  public RiskResponseJpaEntity process(RiskRequestJpaEntity request) {
    RiskResponseJpaEntity responseJpaEntity = getApprovedRiskResponseJpaEntity(request);
    ...
    if (application.isPresent() && application.get().getBorrower() != null) {
      ...
      responseJpaEntity = seonPhoneRule.execute(new SeonPhoneRuleContext(application.get().getId(), currentResponse, isNewSeonData,
          seonPropertyManager.getSeonFraudPhoneStopFactorEnable()));
      responseJpaEntity.setRequestId(request.getId());
    }

...
@Getter
@Setter
public class ScoreCall3ErrContext extends BaseScoreContext {

  private final Long termMaxRestriction;
  private final Long amountMaxRestriction;
  private final Long termMinRestriction;
  private final Long amountMinRestriction;
  ...
  public ScoreCall3ErrContext(RiskResponseJpaEntity response, Integer decision, Integer scoreNodeId, Long termMaxRestriction, Long amountMaxRestriction, Long termMinRestriction,
    ...
    this.amountMinRestriction = amountMinRestriction;
    this.termFromScore = termFromScore;
    this.limitFromScore = limitFromScore;
  }
}

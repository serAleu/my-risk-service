...
public class CooldownApplim9mRule extends BaseCooldownRule<CooldownApplim9mContext> {
  ...
  @Override
  public CooldownApplim9mContext getCurrentCooldownRuleContext(List<CreditApplication> creditApplicationList, List<Credit> creditList, Integer numOf2DApplications,

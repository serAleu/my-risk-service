...
public class StorageDatabaseConfiguration {
  ...
  public DataSourceProperties storageSourceProperties() {
  ...
  public LocalContainerEntityManagerFactoryBean riskEntityManager(@Qualifier("storageDatasource") DataSource storageDataSource) {
